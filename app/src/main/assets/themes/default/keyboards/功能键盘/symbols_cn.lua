...
rows = {
    ...
    {
        keys = {
            { click = "Keyboard_symbols_cn", label = "中符", style = "functional", width = 20 },
            { click = "，", style = "style_W" },
            { click = "。", style = "style_E" },
            { click = "？", style = "style_R" },
            { click = "！", style = "style_T" },
    ...
    {
        keys = {
            { click = "Keyboard_symbols_en", label = "英符", style = "functional", width = 20 },
            { click = "“”{left}", style = "style_W" },
            { click = "‘’{left}", style = "style_E" },
            { click = "……", style = "style_R" },
            { click = "——", style = "style_T" },
            { click = "~", style = "style_Y" },
            { click = "；", style = "style_U" },
    ...
    {
        keys = {
            { click = "Keyboard_number", style = "functional", width = 20, label = "数字" },
            { click = "·", style = "style_W" },
            { click = "|", style = "style_E" },
            { click = "￥", style = "style_R" },
            { click = "•", style = "style_T" },
            { click = "ˇ", style = "style_Y" },
            { click = "℃", style = "style_U" },
            { click = "Keyboard_editor", label = "</>", style = "functional", width = 20 },
        }
    },
    -- 第四行
    {
