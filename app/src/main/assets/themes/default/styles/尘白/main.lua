...
---------------------------------------------------------------------
key = {
    text_color = 0xff2d3748,        -- 文字颜色
    text_size = 20,                 -- 文字大小
    background = 0x7fa0aec8,        -- 按键背景
    elevation = 1,                  -- 阴影凸起
    corner_radius = 4,              -- 按键圆角
    shadow_color = 0x1a000000,      -- 阴影颜色
...
key.hint = {
    ...
    text_color = 0xff718096,        -- 符号文字颜色
    text_size = 6                   -- 符号文字大小
}
key.hint.up = {
    show = show_hints,              -- 上方向符号开关
    text_color = 0xff718096,        -- 上方向符号颜色
    text_size = 7                   -- 上方向符号大小
}
key.hint.down = {
    show = show_hints,              -- 下方向符号开关
    text_color = 0xff718096,        -- 下方向符号颜色
    text_size = 7                   -- 下方向符号大小
}
key.hint.left = {
    show = show_hints,              -- 左方向符号开关
    text_color = 0xff718096,        -- 左方向符号颜色
    text_size = 7                   -- 左方向符号大小
}
key.hint.right = {
    show = show_hints,              -- 右方向符号开关
    text_color = 0xff718096,        -- 右方向符号颜色
    text_size = 7                   -- 右方向符号大小
}
...
key.long_click = {
    ...
    text_color = 0xff4a5568,        -- 长按提示文字颜色
...
key.pressed = {
    ...
    shadow_color = 0x337b93c2,      -- 按下阴影颜色
    background = 0xe7a0aec8,        -- 按下背景色
    text_color = 0xffffffff,        -- 按下文字颜色
    hint = { text_color = 0xffe2e8f0 }, -- 按下符号颜色
    long_click = { text_color = 0xffe2e8f0 } -- 按下长按提示颜色
}
...
popup = {
    ...
    background = 0xb9a0aec8,        -- 键盘背景颜色或图片
    stroke_color = 0xb4a0aec8,      -- 边框颜色
    stroke_width = 5,               -- 边框宽度
...
---------------------------------------------------------------------
symbol = {
    background = 0xfff2f3f5,        -- 符号面板背景
    text_size = 22,                 -- 符号面板文字大小
    text_color = 0xff2d3748,        -- 符号面板文字颜色
    indicator_color = 0xFFa0aec8,   -- 指示器颜色
}
symbol.text = table.clone(key)      -- 符号文本按键样式
symbol.key = {
    text_color = 0xff2d3748,        -- 符号按键文字颜色
    text_size = 18,                 -- 符号按键文字大小
    background = 0x7fa0aec8,        -- 符号按键背景
    elevation = 2,                  -- 符号按键阴影
    corner_radius = 8,              -- 符号按键圆角
    shadow_color = 0x1a7b93c2       -- 符号按键阴影颜色
}
symbol.key.pressed = {
    ...
    shadow_color = 0x337b93c2,      -- 符号按键按下阴影颜色
    background = 0xe7a0aec8         -- 符号按键按下背景色
}
...
candidate.key = {
    text = "end2",                 --候选栏隐藏显示文本
    text_color = 0xffa0aec8,       --候选栏工具文本颜色
    text_size = 15,                --候选栏工具字号
    background = 0xfff2f3f5,       --候选栏工具背景
    elevation = 0,                 --候选栏工具阴影
...
candidate.key.pressed = {
    ...
    shadow_color = 0x337b93c2,     --候选栏工具按下阴影颜色
    background = 0xe7a0aec8        --候选栏工具按下背景
}
...
---------------------------------------------------------------------
candidate.expanded = {
    background = 0xfff2f3f5,        --展开候选面板背景
    text_size = 22,                 --展开候选面板字号
    text_color = 0xff2d3748         --展开候选面板文字颜色
}
candidate.expanded.pressed = {
    background = 0x7fa0aec8,        --展开候选面板按下背景
    ripple_color = 0x40a0aec8       --展开候选面板波纹颜色
}
candidate.expanded.comment = {
    text_size = 15,                 --展开候选面板注释字号
    text_color = 0xff718096,        --展开候选面板注释颜色
}
...
if show_composition then
  composition = {
    ...
    round_corner = 8, -- 窗口圆角
    elevation = 5, -- 阴影
    background = 0x2affffff, --悬浮窗编码背景色
...
enter.background = 0xa2a0aec8        --回车背景
enter.text_color = 0xff2d3748        --回车文字颜色
enter.pressed.background = 0xe7a0aec8 --回车按下背景
...
functional.background = 0x0fa0aec8   --功能键背景
functional.pressed.background = 0xe7a0aec8 --功能键按下背景
functional.pressed.text_color = 0xffffffff --功能键按下文字颜色
functional.preview = nil             --关闭功能键预览

-- 标点键模板（逗号、句号）
period = table.clone(key)
period.text_size = 18                --标点键字号
period.background = 0x17a0aec8       --标点键背景
period.pressed.background = 0xe7a0aec8 --标点键按下背景
period.pressed.text_color = 0xffffffff --标点键按下文字颜色
...
transparent_num.text_color = 0xb92d3748      --数字文字颜色
...
local function make_letter_styles(letters, start_idx)
    ...
    for i, ch in ipairs(letters) do
        ...
        local bg_color = (bg_val << 24) + 0xa0aec8   --按键颜色
...
--功能键颜色单独定义（带渐变）
---------------------------------------------------------------------
style_off = table.clone(functional) style_off.background = 0x0fa0aec8   --关闭键背景
style_Back = table.clone(functional) style_Back.background = 0xd0a0aec8 --退格键背景
style_Sym = table.clone(functional) style_Sym.background = 0x0aa0aec8   --符号键背景
style_Comma = table.clone(period) style_Comma.background = 0x17a0aec8   --逗号键背景
style_Space = table.clone(space) style_Space.background = 0x45a0aec8    --空格键背景
style_Period = table.clone(period) style_Period.background = 0x73a0aec8 --句号键背景
style_Enter = table.clone(enter) style_Enter.background = 0xa2a0aec8    --回车键背景
