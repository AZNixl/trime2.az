...
---------------------------------------------------------------------
-- 键盘整体背景色
background = 0xff2A2F33
-- 键盘面板基础设置
keyboard = {
    height = 200,                       -- 键盘高度
    background = 0xff2A2F33,            -- 键盘背景色
    font= "Gineso.ttf",                 -- 字体
...
---------------------------------------------------------------------
key = {
    text_color = 0xb9ffffff,       -- 文字颜色
    text_size = 20,                -- 文字大小
    background = 0xd048484a,       -- 按键背景
    elevation = 1,                 -- 阴影凸起
...
key.long_click = {
    ...
    text_color = 0xffbbbbbb,        -- 长按提示文字颜色
...
key.pressed = {
    ...
    background = 0xff5a5a5c,        -- 按下背景色
    text_color = 0xffffffff,        -- 按下文字颜色
    hint = { text_color = 0xffbbbbbb }, -- 按下符号颜色
    long_click = { text_color = 0xffbbbbbb } -- 按下长按提示颜色
}
...
---------------------------------------------------------------------
symbol = {
    background = 0xff1d1d1d,        -- 符号面板背景
    text_size = 22,                 -- 符号面板文字大小
    text_color = 0xffffffff,        -- 符号面板文字颜色
    indicator_color = 0xff0a84ff    -- 指示器颜色
}
symbol.text = table.clone(key)      -- 符号文本按键样式
symbol.key = {
    text_color = 0xffffffff,        -- 符号按键文字颜色
    text_size = 18,                 -- 符号按键文字大小
    background = 0xff38383a,        -- 符号按键背景
    elevation = 2,                  -- 符号按键阴影
...
symbol.key.pressed = {
    ...
    background = 0xff5a5a5c         -- 符号按键按下背景色
}
...
candidate.key = {
    text = "end2",                  --候选栏隐藏显示文本
    text_color = 0xb9ffffff,        --候选栏工具文本颜色
    text_size = 15,                 --候选栏工具字号
    background = 0xff2A2F33,        --候选栏工具背景
    elevation = 0,                  --候选栏工具阴影
...
candidate.key.pressed = {
    ...
    background = 0xff5a5a5c         --候选栏工具按下背景
}
...
---------------------------------------------------------------------
candidate.expanded = {
    background = 0xff1d1d1d,        --展开候选面板背景
    text_size = 22,                 --展开候选面板字号
    text_color = 0xffffffff         --展开候选面板文字颜色
}
candidate.expanded.pressed = {
    background = 0xff38383a,        --展开候选面板按下背景
    ripple_color = 0x406a6a6c       --展开候选面板波纹颜色
}
candidate.expanded.comment = {
    text_size = 15,                 --展开候选面板注释字号
    text_color = 0xffbbbbbb         --展开候选面板注释颜色
}
...
preedit = {
    text_size = 0,                 --预编辑字号
    text_color = 0xb9ffffff,        --预编辑文字颜色
    round_corner = 9,               --预编辑圆角
    background = 0xff2A2F33,        --预编辑背景
...
if show_composition then
  composition = {
    ...
    round_corner = 8, -- 窗口圆角
    elevation = 5, -- 阴影
    background = 0xff2A2F33, --悬浮窗编码背景色
    movable = "false", -- 是否可移动窗口，或仅移动一次 true|false|once


    pressed = {
        text_color = 0xb9ffffff,    --悬浮窗输入字母字体颜色
        background = 0xff2A2F33     --悬浮窗输入字母背景色
    },
    window = {
        -- 悬浮窗口组件
        {
...
composition.key.hint={
   ...
   text_color = 0xb9ffffff       --悬浮窗候选序号文本颜色
}
...
enter.background = 0xff0a84ff        --回车背景
enter.text_color = 0xb9ffffff        --回车文字颜色
enter.pressed.background = 0xff0071e3 --回车按下背景
...
functional.background = 0xff333333   --功能键背景
functional.pressed.background = 0xff6a6a6c --功能键按下背景
...
period.background = 0xff333333      --标点键背景
period.pressed.background = 0xff6a6a6c --标点键按下背景
...
transparent_num.text_color = 0xb9ffffff      --数字文字颜色
